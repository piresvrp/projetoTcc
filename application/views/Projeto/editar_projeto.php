                ...
                <div class="col-lg-14">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <div class="line"></div>
                            <?php echo form_open("/Projeto/editar/$dadosProjeto->idprojeto") ?>
                            <div class="form-group-sm">
                                <div class = "form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <label>Nome:</label>
                                        <input type="text" name="nome_projeto" value="<?php echo $dadosProjeto->nome_projeto?>" placeholder="nome do projeto" class="form-control input-sm chat-input" required="required"/>
                                    </div>


                                    <div class="col-md-5">
                                        <label>Segmento:</label>
                                        <input type="text" name="segmento_projeto" value="<?php echo $dadosProjeto->segmento_projeto?>" placeholder="segmento_projeto" class="form-control input-sm chat-input" required="required"/>
                                    </div>
                                    <div class="col-md-5">
                                        <label>Inicio_Projeto:</label>
                                        <input type="date" name="inicio_projeto" value="<?php echo $dadosProjeto->inicio_projeto?>" placeholder="" class="form-control input-sm chat-input" required="required"/>
                                    </div>

                                    <div class="col-md-5">
                                        <label>Fim:</label>
                                        <input type="date" name="fim_projeto" value="<?php echo $dadosProjeto->fim_projeto?>" placeholder="" class="form-control input-sm chat-input" required="required"/>
                                    </div>
                                    <div class="col-md-5">
                                        <label>Descrição:</label>
                                        <input type="text" name="descricao" value="<?php echo $dadosProjeto->descricao?>" placeholder="Descrição do projeto" class="form-control input-sm chat-input" required="required"/></div> 

                                    <div class="col-md-5">
                                        <label>Custo parcial:</label>
                                        <input type="text" name="custo_parcial" value="<?php echo $dadosProjeto->custo_parcial?>" placeholder="custo parcial" class="form-control input-sm chat-input" required="required"/></div> 
                                </div>
                            ...
                            <div class="row">                  
                                ...
                                <div class="adicionar">
                                   <?php $cont = 1; ?>
                                   <?php foreach ($dadosFunc as $dado) { ?>
                                        <input type='hidden' id='dadosFunc<?php echo $cont; ?>' name='dadosFunc[]' value='<?php echo $dado->nome_funcionalidade.'-'.$dado->descricao.'-'.$dado->grau_complexidade.'-'.$dado->tipo_funcao.'-'.$dado->quant_pontof.'-'.$dado->peso?>'/>
                                        <?php $cont++; ?>
                                   <?php } ?> 
                                </div>
                                <table class="table table-responsive table-hover tabela_funcionalidade" id="tabela_funcionalidade">
                                    <thead>
                                     ...
                                     <tbody>
                                         <?php $cont = 1?>
                                        <?php foreach ($dadosFunc as $obj) { ?>        
                                            <tr>
                                                <td><?php echo $obj->nome_funcionalidade; ?></td>
                                                <td><?php echo $obj->descricao; ?></td>                               
                                                <td><?php echo $obj->grau_complexidade;?></td>
                                                <td><?php echo $obj->tipo_funcao?></td>
                                                <td><?php echo $obj->quant_pontof?></td>
                                                <td><?php echo $obj->peso?></td>
                                                <td>
                                                    <a class='remover'  style='cursor:pointer'onclick='remover(<?php echo $cont?>)'>
                                                        <div title='Remover'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <SELECT name="tipo_linguagem" class="form-control input-sm chat-input" required>
                                            <option value="">-- </option>
                                            <option value="php"<?php echo ($dadosProjeto->tipo_linguagem == "php") ?  'selected':'' ?>>php </option>
                                            <option value="C#" <?php echo ($dadosProjeto->tipo_linguagem == "C#") ?  'selected':'' ?>> C# </option>
                                            <option value="java" <?php echo ($dadosProjeto->tipo_linguagem == "java") ?  'selected':'' ?>>Java</option>
                                            <option value="C++" <?php echo ($dadosProjeto->tipo_linguagem == "C++") ?  'selected':'' ?>>c++</option>
                                            <option value="python" <?php echo ($dadosProjeto->tipo_linguagem == "python") ?  'selected':'' ?>>python </option>
                                            <option value="VisualBasic" <?php echo($dadosProjeto->tipo_linguagem == "VisualBasic") ?  'selected':'' ?>>viual Basic </option>
                                        </select>
                                    </div>

                                    <div class="col-md-5">
                                        <label>Tempo Linguagem:</label>
                                        <input type="time" value="<?php echo $dadosProjeto->tempo_gasto?>" name="tempo_gasto" placeholder="tempo_gasto por linguagem" class="form-control input-sm chat-input" required="required"/>
                                    </div></div>
                                <div class = "line">
                                    <div class = "form-group row">
                                        <div class="col-md-12">
